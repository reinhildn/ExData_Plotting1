...
par(mfrow = c(2,2))
with(use, plot(DateTime, Global_active_power, ylab = "Global Active Power", xlab = "", type = "l", col = "black"))
with(use, plot(DateTime, Voltage, ylab = "Voltage", xlab = "datetime", type = "l", col = "black"))
...
with(use, plot(DateTime, Global_reactive_power, xlab = "datetime", type = "l", col = "black"))
